...
public interface zzbu extends IInterface {
    ...
    void zzH(zzavb zzavbVar) throws RemoteException;
    ...
    void zzM(zzbrl zzbrlVar) throws RemoteException;

    void zzN(boolean z) throws RemoteException;

    void zzO(zzbbp zzbbpVar) throws RemoteException;

    void zzP(zzdg zzdgVar) throws RemoteException;

    void zzQ(zzbro zzbroVar, String str) throws RemoteException;

    void zzR(String str) throws RemoteException;

    void zzS(zzbuj zzbujVar) throws RemoteException;
