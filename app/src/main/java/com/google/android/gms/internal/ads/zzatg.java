...
public final class zzatg implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, Application.ActivityLifecycleCallbacks {
    private static final long zzc = ((Long) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbar.zzbf)).longValue();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:165:0x0114, code lost:
        if (r11 == 0) goto L45;
     */
    /* JADX WARN: Code restructure failed: missing block: B:172:0x012a, code lost:
        if (r11 == 0) goto L45;
     */
    ...
    */
    ...
    private final void zzl(View view) {
        ...
        if (application != null) {
            try {
                ...
                zzbza.zzh("Error registering activity lifecycle callbacks.", e);
            }
        }
    }
    ...
    private final void zzm(View view) {
        try {
            ...
            zzbza.zzh("Error while unregistering listeners from the last ViewTreeObserver.", e);
        }
        try {
            ...
            zzbza.zzh("Error while unregistering listeners from the ViewTreeObserver.", e2);
        }
        if (this.zza != null) {
            try {
                com.google.android.gms.ads.internal.zzt.zzv().zzd(this.zzd, this.zza);
            } catch (IllegalStateException e3) {
                zzbza.zzh("Failed trying to unregister the receiver", e3);
            } catch (Exception e4) {
        ...
        if (application != null) {
            try {
                ...
                zzbza.zzh("Error registering activity lifecycle callbacks.", e5);
            }
        }
    }
    ...
    public final void zzc(zzatf zzatfVar) {
        this.zzn.add(zzatfVar);
        zzj(3);
    }
    ...
    public final void zze(zzatf zzatfVar) {
        this.zzn.remove(zzatfVar);
    }
