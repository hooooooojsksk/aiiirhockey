...
public final class zzgac extends zzgcu {
    public zzgac() {
        super(zzglz.class, new zzgaa(zzfvo.class));
    }

    @Override // com.google.android.gms.internal.ads.zzgcu
    public final zzgct zza() {
        return new zzgab(this, zzgmc.class);
    }
    ...
    public final /* synthetic */ zzgrw zzc(zzgpe zzgpeVar) throws zzgqy {
        return zzglz.zze(zzgpeVar, zzgpy.zza());
    }
    ...
    public final /* bridge */ /* synthetic */ void zze(zzgrw zzgrwVar) throws GeneralSecurityException {
        zzgog.zzb(((zzglz) zzgrwVar).zza(), 0);
    }
}
