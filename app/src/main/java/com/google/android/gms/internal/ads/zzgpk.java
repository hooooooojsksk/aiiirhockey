...
public final class zzgpk extends zzgpm {
    ...
    public /* synthetic */ zzgpk(InputStream inputStream, int i, zzgpj zzgpjVar) {
        super(null);
    ...
    public final zzgpe zzw() throws IOException {
        ...
        int i2 = this.zzi;
        if (zzj <= i - i2 && zzj > 0) {
            zzgpe zzw = zzgpe.zzw(this.zzf, i2, zzj);
            this.zzi += zzj;
            return zzw;
        } else if (zzj != 0) {
            byte[] zzO = zzO(zzj);
    ...
    public final String zzx() throws IOException {
        ...
        if (zzj > 0) {
            ...
            int i2 = this.zzi;
            if (zzj <= i - i2) {
                String str = new String(this.zzf, i2, zzj, zzgqw.zzb);
                this.zzi += zzj;
                return str;
            }
        }
        ...
        if (zzj <= this.zzg) {
            zzL(zzj);
            String str2 = new String(this.zzf, this.zzi, zzj, zzgqw.zzb);
            this.zzi += zzj;
            return str2;
        }
        return new String(zzN(zzj, false), zzgqw.zzb);
    }
