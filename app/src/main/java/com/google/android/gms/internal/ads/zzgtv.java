...
public final class zzgtv {
    ...
    */
    ...
    public static String zzg(ByteBuffer byteBuffer, int i, int i2) throws zzgqy {
        zzgts zzgtsVar = zza;
        if (byteBuffer.hasArray()) {
            return zzgtsVar.zzb(byteBuffer.array(), byteBuffer.arrayOffset() + i, i2);
        } else if (!byteBuffer.isDirect()) {
            return zzgts.zzd(byteBuffer, i, i2);
        } else {
            return zzgtt.zzd(byteBuffer, i, i2);
        }
    }

    public static String zzh(byte[] bArr, int i, int i2) throws zzgqy {
