...
public final class zzyc implements Choreographer.FrameCallback, Handler.Callback {
    ...
    public final boolean handleMessage(Message message) {
        ...
        if (i == 0) {
            try {
                ...
                zzee.zzf("VideoFrameReleaseHelper", "Vsync sampling disabled due to platform error", e);
            }
            return true;
        } else if (i == 1) {
