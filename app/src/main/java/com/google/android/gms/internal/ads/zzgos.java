...
public final class zzgos extends zzgoo implements RandomAccess, zzgqv, zzgsd {
    private static final zzgos zza;
    private boolean[] zzb;
    private int zzc;

    static {
        zzgos zzgosVar = new zzgos(new boolean[0], 0);
        zza = zzgosVar;
        zzgosVar.zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzgosVar.zzb, 0, this.zzb, this.zzc, zzgosVar.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzgosVar.zzc) {
            return false;
        }
        boolean[] zArr = zzgosVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzgqv zzd(int i) {
        ...
        return new zzgos(Arrays.copyOf(this.zzb, i), this.zzc);
    }
    ...
    private zzgos(boolean[] zArr, int i) {
        this.zzb = zArr;
        this.zzc = i;
    }
