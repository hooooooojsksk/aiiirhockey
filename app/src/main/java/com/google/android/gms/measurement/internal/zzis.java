...
public final class zzis extends zzf {
    ...
    public final void zzr(Activity activity, Bundle bundle) {
        ...
        this.zzd.put(activity, new zzik(bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.NAME), bundle2.getString("referrer_name"), bundle2.getLong(FacebookMediationAdapter.KEY_ID)));
    }
