...
public final class zzevw implements zzgwy {
    ...
    public zzevw(zzgxl zzgxlVar, zzgxl zzgxlVar2, zzgxl zzgxlVar3) {
        this.zza = zzgxlVar;
        this.zzb = zzgxlVar2;
        this.zzc = zzgxlVar3;
    }
    ...
    public final zzevt zzb() {
        ...
        if (((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbar.zzfV)).intValue() > 0) {
            if (!((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbar.zzfS)).booleanValue() || z) {
                zzfaw zza = zzfaxVar.zza(zzfan.Rewarded, context, zzfafVar, new zzeux(new zzeuu()));
