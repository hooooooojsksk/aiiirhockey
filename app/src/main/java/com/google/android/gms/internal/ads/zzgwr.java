...
public final class zzgwr {
    ...
    public zzgwr(double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
        this.zze = d5;
        this.zzf = d6;
        this.zzg = d7;
        this.zzh = d;
    ...
    public final boolean equals(Object obj) {
        ...
        return Double.compare(zzgwrVar.zzh, this.zzh) == 0 && Double.compare(zzgwrVar.zzi, this.zzi) == 0 && Double.compare(zzgwrVar.zzj, this.zzj) == 0 && Double.compare(zzgwrVar.zzk, this.zzk) == 0 && Double.compare(zzgwrVar.zzl, this.zzl) == 0 && Double.compare(zzgwrVar.zzm, this.zzm) == 0 && Double.compare(zzgwrVar.zze, this.zze) == 0 && Double.compare(zzgwrVar.zzf, this.zzf) == 0 && Double.compare(zzgwrVar.zzg, this.zzg) == 0;
    }
