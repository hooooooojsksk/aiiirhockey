...
public interface zzgsh {
    void zzA(List list) throws IOException;

    void zzB(List list) throws IOException;

    @Deprecated
    void zzC(List list, zzgsp zzgspVar, zzgpy zzgpyVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzgsp zzgspVar, zzgpy zzgpyVar) throws IOException;
    ...
    zzgpe zzp() throws IOException;

    String zzr() throws IOException;

    String zzs() throws IOException;

    void zzt(Object obj, zzgsp zzgspVar, zzgpy zzgpyVar) throws IOException;

    void zzu(Object obj, zzgsp zzgspVar, zzgpy zzgpyVar) throws IOException;
