...
public class ViewPager$SavedState extends AbsSavedState {
    ...
    public static void A02() {
        byte[] bArr = {26, airhockey.P_GAME_EXIT, 85, airhockey.P_GAME_REMATCH, 83, 78, 83, 85, 84, 7, airhockey.J_ENEMYLOSE, 92, 79, airhockey.P_GAME_REMATCH, airhockey.P_GAME_MYSCORE, 75, 64, 90, 126, 79, airhockey.P_GAME_REMATCH, 75, 92, 0, 125, 79, 88, 75, airhockey.P_GAME_EXIT, 125, 90, 79, 90, 75, 85, airhockey.J_INVITE};
        if (A04[0].length() == 0) {
