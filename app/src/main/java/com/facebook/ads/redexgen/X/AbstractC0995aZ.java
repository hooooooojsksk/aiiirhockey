...
public abstract class AbstractC0995aZ implements C0B {
    ...
    static {
        A04();
        A03 = AbstractC0995aZ.class.getSimpleName();
    }
    ...
    public void AFb(File file) throws IOException {
        this.A00.submit(new Callable<Void>(file) { // from class: com.facebook.ads.redexgen.X.0F
            ...
            public final Void call() throws Exception {
                AbstractC0995aZ.this.A06(this.A00);
                return null;
            }
        });
    }
