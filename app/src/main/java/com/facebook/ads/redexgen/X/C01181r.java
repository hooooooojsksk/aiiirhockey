...
public final class C01181r {
    ...
    public static AdSettings.IntegrationErrorMode A00(C0887Xc c0887Xc) {
        ...
        if (integrationErrorMode == integrationErrorMode2 && !A03(c0887Xc)) {
    ...
    public static boolean A03(C0887Xc c0887Xc) {
        return (c0887Xc.getApplicationInfo().flags & 2) != 0;
    }
}
