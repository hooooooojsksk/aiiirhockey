...
public final class C0598Lu {
    ...
    public static void A02() {
        A00 = new byte[]{61, 57, 58, 14, 31, 18, 30, 21, 24, 30, 53, 30, 15, 12, 20, 9, 16, 9, 46, 38, 35, 111, 59, 32, 111, 61, 42, 33, 43, 42, 61, 111, 1, 46, 59, 38, 57, 42, 111, 59, 42, 34, 63, 35, 46, 59, 42, airhockey.J_SDKVER, 111, 10, 34, 63, 59, 54, 111, 14, 33, 43, 61, 32, 38, 43, 111, 25, 38, 42, 56, 111, 56, 38, 35, 35, 111, 45, 42, 111, 61, 42, 59, 58, 61, 33, 42, 43, airhockey.J_SDKVER, 52, 59, 46, 51, 44, 63, 5, 46, 63, 55, 42, 54, 59, 46, 63};
    }
    ...
    public static View A00(C0887Xc c0887Xc, Throwable th) {
        A03(c0887Xc, th);
        return new View(c0887Xc);
    }

    public static void A03(C0887Xc c0887Xc, Throwable th) {
        c0887Xc.A07().A9C(A01(85, 15, 44), C02627s.A1v, new C02637t(th));
