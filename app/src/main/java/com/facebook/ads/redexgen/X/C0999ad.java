...
public final class C0999ad implements AnonymousClass03<Bitmap> {
    ...
    public final String A02 = C0999ad.class.getSimpleName();
    ...
    public static void A02() {
        ...
        A06 = new byte[]{1, 91, airhockey.P_NATION, 95, 7, 44, 49, 40, 36, 53, airhockey.J_GAME_STANDBY, 44, 54, airhockey.J_GAME_STANDBY, 43, 48, 41, 41, 124, 65, 90, 92, airhockey.P_GAME_REMATCH, 77, 80, 86, 87, 25, 93, 76, 75, 80, 87, 94, 25, 95, 80, 85, 92, 25, 90, 86, 84, airhockey.P_GAME_REMATCH, 75, 92, airhockey.P_GAME_EXIT, airhockey.P_GAME_EXIT, 80, 86, 87};
    }
    ...
    public C0999ad(int i, int i2, boolean z, boolean z2, boolean z3) {
        this.A01 = i;
        this.A00 = i2;
        this.A05 = z;
        this.A03 = z2;
    ...
    public final AnonymousClass02<Bitmap> A3B(File file, C0L c0l) {
        ...
        try {
            ...
            c0l.A96(new C0993aX(A01(4, 14, 77)));
            return A00(null);
        } catch (Throwable th) {
            if (A07[6].length() == 26) {
    ...
    @Override // com.facebook.ads.redexgen.X.AnonymousClass03
    @SuppressLint({"CatchGeneralException"})
    public final void A4E(File file, C0L c0l) throws C0993aX {
        if (this.A03) {
            try {
                ...
                c0l.A9G(th);
                Throwable t = new C0993aX(A01(18, 33, 49), th);
                throw t;
            }
        }
    }
