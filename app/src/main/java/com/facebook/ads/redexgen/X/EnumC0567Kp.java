...
public enum EnumC0567Kp {
    ...
    EnumC0567Kp(int i, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i;
        this.A01 = nativeComponentTag;
    }

    public static EnumC0567Kp A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC0567Kp[] values;
        for (EnumC0567Kp enumC0567Kp : values()) {
            if (enumC0567Kp.A01 == nativeComponentTag) {
                return enumC0567Kp;
            }
        }
        return null;
    ...
    public static void A03(View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC0567Kp internalTag = A00(nativeComponentTag);
        if (view != null && internalTag != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(View view, EnumC0567Kp enumC0567Kp) {
        if (view != null && enumC0567Kp != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, enumC0567Kp);
        }
    }
