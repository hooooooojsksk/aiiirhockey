...
public final class C02477b {
    ...
    public C02477b(Set<String> options, @Nullable Integer num, @Nullable Integer num2, String str) {
        this.A03 = options;
    ...
    public C02477b(@Nullable String[] strArr, @Nullable Integer num, @Nullable Integer num2) {
    ...
    @Nullable
    public static C02477b A00(@Nullable String str) {
        if (str == null) {
            return null;
        }
        ...
        return new C02477b(linkedHashSet, num, num2, str);
    }
    ...
    public final boolean equals(@Nullable Object obj) {
        if (obj instanceof C02477b) {
            C02477b c02477b = (C02477b) obj;
            ...
            A06[0] = "YHhc40Na8nm";
            Integer num2 = c02477b.A00;
            if (num == num2 || (num != null && num.equals(num2))) {
                Integer num3 = this.A01;
                Integer num4 = c02477b.A01;
                return (num3 == num4 || (num3 != null && num3.equals(num4))) && this.A03.equals(c02477b.A03);
            }
            return false;
        }
        return false;
