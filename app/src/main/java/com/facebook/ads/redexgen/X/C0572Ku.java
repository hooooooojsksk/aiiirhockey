...
public final class C0572Ku {
    ...
    public static void A01() {
        A02 = new byte[]{9, 46, 54, 33, 44, 41, 36, 96, 46, 53, 45, 34, 37, 50, 96, 47, 38, 96, 46, 33, 46, 47, 51, 37, 35, 47, 46, 36, 51, 96, 38, 47, 50, 96, 52, 40, 37, 96, 52, 41, 45, 37, 50, airhockey.J_PURCHASE, 96, airhockey.J_GAME_STANDBY, 36};
    }

    public C0572Ku(long j) {
        if (j < 0) {
