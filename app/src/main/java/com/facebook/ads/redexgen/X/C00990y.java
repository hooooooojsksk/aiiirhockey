...
public final class C00990y extends BroadcastReceiver {
    ...
    public C00990y(C0887Xc c0887Xc, String str, C0969a9 c0969a9, InterfaceC00980x interfaceC00980x) {
        this.A02 = c0887Xc;
        this.A03 = str;
        this.A01 = interfaceC00980x;
        this.A00 = c0969a9;
    }
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if (intentAction5.equals(str)) {
            InterfaceC00980x interfaceC00980x = this.A01;
            C0969a9 c0969a9 = this.A00;
            String[] parts3 = A05;
            if (parts3[3].charAt(4) != 'D') {
                A05[0] = "TqpNublq1V6zWfVafs4QLB";
                interfaceC00980x.ABG(c0969a9);
                return;
            }
        ...
        if (intentAction9.equals(str)) {
            InterfaceC00980x interfaceC00980x2 = this.A01;
            String[] strArr = A05;
        ...
        InterfaceC00980x interfaceC00980x3 = this.A01;
        String[] parts4 = A05;
        if (parts4[7].charAt(0) != 'P') {
            throw new RuntimeException();
        }
        A05[0] = "2dNMpRkIvORsTqY7tSIXPx";
        interfaceC00980x3.ABL();
    }
}
