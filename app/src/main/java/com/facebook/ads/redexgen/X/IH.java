...
public class IH implements ServiceConnection {
    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        C0887Xc c0887Xc;
        Messenger messenger;
        this.A00.A08(C02627s.A1q, new C02637t(A00(0, 17, 51)));
        this.A00.A01 = true;
        ...
        try {
            ...
            this.A00.A07(C02627s.A1p, new C02637t(e));
        }
        c0887Xc = this.A00.A03;
        c0887Xc.unbindService(this);
        String[] strArr = A02;
    ...
    public final void onServiceDisconnected(ComponentName componentName) {
        C0887Xc c0887Xc;
        this.A00.A08(C02627s.A1r, new C02637t(A00(17, 20, 24)));
        try {
            c0887Xc = this.A00.A03;
            c0887Xc.unbindService(this);
