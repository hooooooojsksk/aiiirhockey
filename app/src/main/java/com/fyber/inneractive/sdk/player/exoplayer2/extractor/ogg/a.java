...
public final class a implements f {
    ...
    public class C0041a implements m {
        ...
        public long a(long j) {
            ...
            long j2 = aVar.b;
            long j3 = aVar.c;
            long j4 = (((((aVar.d.i * j) / 1000000) * (j3 - j2)) / aVar.f) - WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS) + j2;
            if (j4 >= j2) {
                j2 = j4;
            }
                    ...
                    if (!a(gVar, j7)) {
                        ...
                        if (i3 >= 0 && j10 <= 72000) {
                            ...
                            if (j15 < 100000) {
                                ...
                                min = Math.min(Math.max((bVar.c - (i2 * (i3 <= 0 ? 2 : 1))) + ((j10 * j15) / (this.l - this.k)), j14), this.j - 1);
                            }
                        }
                        min = -(j + 2);
                    }
    ...
    public boolean a(com.fyber.inneractive.sdk.player.exoplayer2.extractor.g gVar, long j) throws IOException, InterruptedException {
        ...
        while (true) {
            com.fyber.inneractive.sdk.player.exoplayer2.extractor.b bVar = (com.fyber.inneractive.sdk.player.exoplayer2.extractor.b) gVar;
            int i3 = 0;
            if (bVar.c + i2 > min && (i2 = (int) (min - bVar.c)) < 4) {
                return false;
            }
