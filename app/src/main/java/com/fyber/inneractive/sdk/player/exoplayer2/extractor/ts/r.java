            ...
            if (i < 3) {
                ...
                if (i2 == 3) {
                    ...
                    if (b < i3) {
                        ...
                        byte[] bArr = kVar2.a;
                        kVar2.c(Math.min((int) InputDeviceCompat.SOURCE_TOUCHSCREEN, Math.max(i3, bArr.length * 2)));
                ...
                if (i4 != i5) {
                    ...
                    if (this.e) {
                        ...
                        for (int i8 = 0; i8 < i5; i8++) {
                            i7 = com.fyber.inneractive.sdk.player.exoplayer2.util.u.h[((i7 >>> 24) ^ (bArr2[i8] & UByte.MAX_VALUE)) & 255] ^ (i7 << 8);
                        }
                        if (i7 != 0) {
                            this.f = true;
                            return;
