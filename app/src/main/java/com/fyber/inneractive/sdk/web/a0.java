...
public class a0 {
    ...
    public a0(byte[] bArr, Map<String, String> map, String str, String str2, int i, String str3) {
        this.a = bArr;
        this.b = map;
        this.c = str;
        this.d = str2;
            ...
            for (String str2 : this.b.keySet()) {
                if (!z) {
                    ...
                    if (str3 != null) {
                        ...
                        int a = (matcher.find() && matcher.groupCount() == 1) ? com.fyber.inneractive.sdk.util.q.a(matcher.group(1), 0) : 0;
                        if ((str3.toLowerCase(locale).contains(HeaderConstants.PUBLIC) || str3.toLowerCase(locale).contains(HeaderConstants.PRIVATE) || a > TimeUnit.SECONDS.convert(1L, TimeUnit.HOURS)) && !str3.toLowerCase(locale).contains("no-") && !str3.toLowerCase(locale).contains("must-")) {
                            break;
                        }
                        z = false;
                    } else {
                    ...
                    if (str2 == null || !str2.equalsIgnoreCase("Vary")) {
                        if (str2 != null && str2.equalsIgnoreCase("Pragma")) {
                            ...
                            if (str4 != null) {
                                z = !str4.equalsIgnoreCase(HeaderConstants.CACHE_CONTROL_NO_CACHE);
                            }
