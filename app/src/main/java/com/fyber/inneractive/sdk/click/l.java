...
public class l {
    ...
    public void a(Context context, String str, b bVar, t tVar, boolean z, com.fyber.inneractive.sdk.ignite.k kVar, String str2) {
        Uri uri;
        this.a = context;
        this.b = str;
        this.d = bVar;
        ...
        if (a2 == null) {
            ...
            try {
                ...
                if (a(uri)) {
                    ...
                    m0 m0Var = new m0(new k(this, uri2, str2), uri2, v.a().c());
                    this.g = m0Var;
                    IAConfigManager.M.s.c(m0Var);
                }
            } catch (Exception e) {
