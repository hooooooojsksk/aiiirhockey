...
public class FyberReportAdActivity extends Activity {
    public static com.fyber.inneractive.sdk.flow.e b;
    public WebView a;
    ...
    public static void start(Context context, com.fyber.inneractive.sdk.flow.e eVar) {
        b = eVar;
        try {
            context.startActivity(new Intent(context, FyberReportAdActivity.class));
        } catch (Exception e) {
