...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m1337getAdjustmentUwyO8pc() {
    ...
    public long mo1334elapsedNowUwyO8pc() {
        return Duration.m1377minusLRDsOJo(this.mark.mo1334elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1336plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1378plusLRDsOJo(this.adjustment, j), null);
    }
}
