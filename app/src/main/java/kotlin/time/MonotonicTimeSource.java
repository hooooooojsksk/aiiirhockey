...
public final class MonotonicTimeSource implements TimeSource {
    ...
    public /* bridge */ /* synthetic */ TimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1480boximpl(m1474markNowz9LOYto());
    }
    ...
    public long m1474markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1481constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k */
    public final long m1473elapsedFrom6eNON_k(long j) {
        return LongSaturatedMathKt.saturatingDiff(read(), j);
    }

    /* renamed from: adjustReading-6QKq23U */
    public final long m1472adjustReading6QKq23U(long j, long j2) {
        return TimeSource.Monotonic.ValueTimeMark.m1481constructorimpl(LongSaturatedMathKt.m1470saturatingAddpTJri5U(j, j2));
    }
}
