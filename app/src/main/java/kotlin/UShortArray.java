...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public static final /* synthetic */ UShortArray m357boximpl(short[] sArr) {
        return new UShortArray(sArr);
    }

    /* renamed from: constructor-impl */
    public static short[] m359constructorimpl(short[] storage) {
    ...
    public static final short m364getMh2AYeg(short[] sArr, int i) {
    ...
    public static java.util.Iterator<UShort> m368iteratorimpl(short[] sArr) {
    ...
    public static final class Iterator implements java.util.Iterator<UShort>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ UShort next() {
            return UShort.m301boximpl(m374nextMh2AYeg());
        }
    ...
    public static boolean m361containsAllimpl(short[] sArr, Collection<UShort> elements) {
        boolean z;
        Intrinsics.checkNotNullParameter(elements, "elements");
        Collection<UShort> collection = elements;
        if (!collection.isEmpty()) {
            for (Object obj : collection) {
                if ((obj instanceof UShort) && ArraysKt.contains(sArr, ((UShort) obj).m356unboximpl())) {
                    z = true;
                    continue;
                } else {
                    z = false;
