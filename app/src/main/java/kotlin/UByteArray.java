...
public final class UByteArray implements Collection<UByte>, KMappedMarker {
    ...
    public static final /* synthetic */ UByteArray m97boximpl(byte[] bArr) {
    ...
    public static boolean m102equalsimpl(byte[] bArr, Object obj) {
        return (obj instanceof UByteArray) && Intrinsics.areEqual(bArr, ((UByteArray) obj).m113unboximpl());
    }
    ...
    public static final byte m104getw2LRezQ(byte[] bArr, int i) {
        return UByte.m47constructorimpl(bArr[i]);
    }
    ...
    public static java.util.Iterator<UByte> m108iteratorimpl(byte[] bArr) {
    ...
    public static final class Iterator implements java.util.Iterator<UByte>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ UByte next() {
            return UByte.m41boximpl(m114nextw2LRezQ());
        }
    ...
    public boolean containsAll(Collection<? extends Object> elements) {
        ...
        return m101containsAllimpl(this.storage, elements);
    }

    /* renamed from: containsAll-impl */
    public static boolean m101containsAllimpl(byte[] bArr, Collection<UByte> elements) {
        boolean z;
        Intrinsics.checkNotNullParameter(elements, "elements");
        Collection<UByte> collection = elements;
        if (!collection.isEmpty()) {
            for (Object obj : collection) {
                if ((obj instanceof UByte) && ArraysKt.contains(bArr, ((UByte) obj).m96unboximpl())) {
                    z = true;
                    continue;
                } else {
                    z = false;
