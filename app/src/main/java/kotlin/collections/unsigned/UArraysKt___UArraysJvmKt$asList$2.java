...
public final class UArraysKt___UArraysJvmKt$asList$2 extends AbstractList<ULong> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof ULong) {
            return m536containsVKZWuLQ(((ULong) obj).m252unboximpl());
        }
        return false;
    }
    ...
    public /* bridge */ /* synthetic */ Object get(int i) {
        return ULong.m195boximpl(m537getsVKNKU(i));
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof ULong) {
            return m538indexOfVKZWuLQ(((ULong) obj).m252unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof ULong) {
            return m539lastIndexOfVKZWuLQ(((ULong) obj).m252unboximpl());
        }
        return -1;
    }
    ...
    public int getSize() {
        return ULongArray.m261getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return ULongArray.m263isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-VKZWuLQ */
    public boolean m536containsVKZWuLQ(long j) {
        return ULongArray.m256containsVKZWuLQ(this.$this_asList, j);
    }

    /* renamed from: get-s-VKNKU */
    public long m537getsVKNKU(int i) {
        return ULongArray.m260getsVKNKU(this.$this_asList, i);
    }
