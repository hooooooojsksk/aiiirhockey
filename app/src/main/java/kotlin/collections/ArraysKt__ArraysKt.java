        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m595contentEqualskV0jMPg(((UByteArray) t).m113unboximpl(), ((UByteArray) t2).m113unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m592contentEqualsFGO6Aew(((UShortArray) t).m373unboximpl(), ((UShortArray) t2).m373unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m593contentEqualsKJPZfPQ(((UIntArray) t).m191unboximpl(), ((UIntArray) t2).m191unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m597contentEqualslec5QzE(((ULongArray) t).m269unboximpl(), ((ULongArray) t2).m269unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m609contentToString2csIQuQ(uByteArray != null ? uByteArray.m113unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m613contentToStringd6D3K8(uShortArray != null ? uShortArray.m373unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m612contentToStringXUkPCBk(uIntArray != null ? uIntArray.m191unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m615contentToStringuLth9ew(uLongArray != null ? uLongArray.m269unboximpl() : null));
            } else {
