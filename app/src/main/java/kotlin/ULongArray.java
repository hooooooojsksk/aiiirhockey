...
public final class ULongArray implements Collection<ULong>, KMappedMarker {
    ...
    public static long[] m255constructorimpl(long[] storage) {
    ...
    public static boolean m258equalsimpl(long[] jArr, Object obj) {
        return (obj instanceof ULongArray) && Intrinsics.areEqual(jArr, ((ULongArray) obj).m269unboximpl());
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof ULong) {
            return m268containsVKZWuLQ(((ULong) obj).m252unboximpl());
        }
        return false;
    }
    ...
    public static final class Iterator implements java.util.Iterator<ULong>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ ULong next() {
            return ULong.m195boximpl(m270nextsVKNKU());
        }
    ...
    public static boolean m257containsAllimpl(long[] jArr, Collection<ULong> elements) {
        boolean z;
        Intrinsics.checkNotNullParameter(elements, "elements");
        Collection<ULong> collection = elements;
        if (!collection.isEmpty()) {
            for (Object obj : collection) {
                if ((obj instanceof ULong) && ArraysKt.contains(jArr, ((ULong) obj).m252unboximpl())) {
                    z = true;
                    continue;
                } else {
                    z = false;
